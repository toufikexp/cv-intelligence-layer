...
SKILLS: list[tuple[str, str, str | None, int | None]] = [
    ...
    ('FIN_INS_POLICY', 'Insurance Planning & Policies Development', 'Finance', 101),
    ('MKT_IMC', 'Integrated Marketing Communication', 'Marketing', 102),
    ('NET_DIMENSION', 'Integrated Network Dimensioning', 'Network', 103),
    ('AUDIT_INTERNAL', 'Internal Audit Planning & Execution', 'Audit', 104),
    ('CORP_INTERNAL_COMM', 'Internal Communication Management', 'Corporate', 105),
    ('FIN_INTERNAL_CTRL', 'Internal Control', 'Finance', 106),
    ('AUDIT_IPPF', 'International Professional Practices Framework (IPPF)', 'Audit', 107),
    ('TECH_IOT_M2M', 'Internet of Things (and M2M)', 'Technology', 108),
    ('LOG_INVENTORY', 'Inventory Management & Optimization', 'Logistics', 109),
    ('FIN_INVESTMENT', 'Investment Evaluation & Management', 'Finance', 110),
    ('IT_PLATFORM_OPS', 'IT Platforms Operations', 'IT', 111),
    ('HR_JOB_DESIGN', 'Job Analysis - Design & Evaluation', 'HR', 112),
    ('SALES_KAM', 'Key Account Management', 'Sales', 113),
    ('IT_KB', 'Knowledge Base Management', 'IT', 114),
    ('LEGAL_LABOR', 'Labor Law & Employment Legislation', 'Legal', 115),
    ('CORP_LOBBYING', 'Lobbying', 'Corporate', 116),
    ('LEGAL_DIGITAL', 'Local Digital Laws & Regulations', 'Legal', 117),
    ('COMM_LANGUAGE', 'Local Language Knowledge', 'Communication', 118),
    ('LOG_WAREHOUSE', 'Logistics & Warehousing', 'Logistics', 119),
    ('DATA_AI_ML', 'Machine Learning - Artificial Intelligence', 'Data', 120),
    ('FIN_MGMT_REPORT', 'Management Reporting', 'Finance', 121),
    ('MKT_RESEARCH', 'Market Research & Study', 'Marketing', 122),
    ('MKT_SEGMENT', 'Market Segmentation', 'Marketing', 123),
    ('ENG_MEP', 'Mechanical - Electrical & Plumbing Knowledge', 'Engineering', 124),
    ('MKT_MEDIA', 'Media Planning & Management', 'Marketing', 125),
    ('DIG_MEDIA_TECH', 'Media Technologies', 'Digital', 126),
    ('OPS_MEETING', 'Meeting Administration', 'Operations', 127),
    ('COMM_MESSAGE', 'Message Handling', 'Communication', 128),
    ('TELCO_MFS_SERV', 'MFS Adjacent Services & Products', 'Telecom', 129),
    ('TELCO_MFS_TRENDS', 'MFS Ecosystem & Trends', 'Telecom', 130),
    ('MKT_COMM_EFFECT', 'Monitoring & Measuring Communication Effectiveness', 'Marketing', 131),
    ('SOFT_NEGOTIATION', 'Negotiation', 'Soft Skills', 132),
    ('NET_ANALYTICS', 'Network Analytics', 'Network', 133),
    ('NET_MONITORING', 'Network Monitoring', 'Network', 134),
    ('NET_NOC', 'Network Operations Center (NOC)', 'Network', 135),
    ('NET_OPTIMIZATION', 'Network Optimization', 'Network', 136),
    ('NET_PERFORMANCE', 'Network Performance Management', 'Network', 137),
    ('NET_TESTING', 'Network Testing', 'Network', 138),
    ('NET_NV', 'Network Virtualization (NV)', 'Network', 139),
    ('DIG_MARKETING', 'Online - Digital Marketing', 'Digital', 140),
    ('SALES_DIGITAL', 'Online - Digital Sales', 'Sales', 141),
    ('HR_ORG_STRUCT', 'Organizational Structuring', 'HR', 142),
    ('MKT_OUTDOOR', 'Outdoor Advertising Management', 'Marketing', 143),
    ('STRAT_PARTNERSHIP', 'Partnership Engagement - Execution & Monitoring', 'Business Strategy', 144),
    ('NET_PASSIVE_INFRA', 'Passive Infrastructure Deployment', 'Network', 145),
    ('NET_PASSIVE_OPS', 'Passive Network Operations', 'Network', 146),
    ('FIN_PAYROLL', 'Payroll Process Management', 'Finance', 147),
    ('ANALYTICS_DASHBOARD', 'Performance Dashboard Design & Development', 'Analytics', 148),
    ('HR_PERF_REPORT', 'Performance Management & Reporting', 'HR', 149),
    ('HR_MEASURE_REPORT', 'Performance Measurement & Reporting', 'HR', 150),
    ('FIN_BUDGETING', 'Planning & Budgeting', 'Finance', 151),
    ('SOFT_PROBLEM_SOLV', 'Problem Solving', 'Soft Skills', 152),
    ('PM_PORTFOLIO', 'Product - Portfolio Strategy Development', 'Product Management', 153),
    ('PM_PRODUCT_DEV', 'Product Development', 'Product Management', 154),
    ('PM_LIFECYCLE', 'Product Portfolio & Lifecycle Management', 'Product Management', 155),
    ('PM_PROJECT', 'Project Management', 'Project Management', 156),
    ('TELCO_PROTOCOL', 'Protocol Service Knowledge', 'Telecom', 157),
    ('MKT_PR', 'Public Relations', 'Marketing', 158),
    ('QUALITY_QMS', 'QMS Implementation & Maintenance', 'Quality', 159),
    ('LEGAL_REG_ECO', 'Regulatory Economics', 'Legal', 160),
    ('FIN_R2P', 'Request to Pay Process (R2P)', 'Finance', 161),
    ('SALES_RETAIL', 'Retail Sales Operations', 'Sales', 162),
    ('CX_LOYALTY', 'Retention & Loyalty Program Management', 'Customer Experience', 163),
    ('FIN_REV_ASSURANCE', 'Revenue Assurance Systems & Tools', 'Finance', 164),
    ('FIN_REV_CYCLE', 'Revenue Cycle Management', 'Finance', 165),
    ('FIN_REV_LEAK', 'Revenue Leakage Control', 'Finance', 166),
    ('HR_REWARD', 'Reward Management', 'HR', 167),
    ('RISK_APPETITE', 'Risk Appetite Framework Management', 'Risk', 168),
    ('RISK_IDENTIFY', 'Risk Identification & Assessment', 'Risk', 169),
    ('RISK_MGMT', 'Risk Management', 'Risk', 170),
    ('RISK_POLICY', 'Risk Management Policy & Procedures', 'Risk', 171),
    ('RISK_RESPONSE', 'Risk Response & Reporting', 'Risk', 172),
    ('LOG_ROUTE', 'Route Planning & Traffic Regulations', 'Logistics', 173),
    ('OPS_SAFETY', 'Safety Management', 'Operations', 174),
    ('SALES_ANALYTICS', 'Sales & Distribution Analytics', 'Sales', 175),
    ('SALES_AUTO', 'Sales Automation', 'Sales', 176),
    ('SALES_FULFILL', 'Sales Fulfillment', 'Sales', 177),
    ('SALES_TRAIN', 'Sales Training', 'Sales', 178),
    ('OPS_RESOURCES', 'Scarce Resources Management', 'Operations', 179),
    ('SEC_PLANNING', 'Security Planning', 'Security', 180),
    ('TELCO_SERVICE_QA', 'Service Assurance & Quality', 'Telecom', 181),
    ('TELCO_SERVICE_CFG', 'Service Configuration & Activation Process', 'Telecom', 182),
    ('TELCO_DELIVERY', 'Service Delivery Networks', 'Telecom', 183),
    ('TELCO_SERVICE_MON', 'Service Quality Monitoring & Compliance', 'Telecom', 184),
    ('IT_SERVICE', 'Service-Orientated IT', 'IT', 185),
    ('IT_SERVICES_INT', 'Services Integration', 'IT', 186),
    ('OPS_SHARED_SERV', 'Shared Services Management', 'Operations', 187),
    ('COM_SMART_PRICE', 'Smart Pricing', 'Commercial', 188),
    ('MKT_SOCIAL_MEDIA', 'Social Media Management', 'Marketing', 189),
    ('DATA_STATS', 'Statistics', 'Data', 190),
    ('STRAT_FORMULATION', 'Strategy Formulation', 'Business Strategy', 191),
    ('STRAT_IMPLEMENT', 'Strategy Implementation', 'Business Strategy', 192),
    ('HR_SUCCESSION', 'Succession Planning', 'HR', 193),
    ('PROC_SUPPLIER_NEG', 'Supplier Negotiation & Deal Closing', 'Procurement', 194),
    ('PROC_CONTRACTS', 'Suppliers & Contracts Management', 'Procurement', 195),
    ('PROC_MARKET', 'Supply Market Analysis', 'Procurement', 196),
    ('IT_SYS_INT', 'Systems Integration', 'IT', 197),
    ('HR_TALENT_ASSESS', 'Talent Assessment', 'HR', 198),
    ('HR_CAPABILITY', 'Talent Capability Building', 'HR', 199),
    ('HR_TALENT_ACQ', 'Talent Market Intelligence & Acquisition', 'HR', 200),
    ('FIN_TAX_AUDIT', 'Tax Audit & Planning', 'Finance', 201),
    ('FIN_TAX_RETURN', 'Tax Return Preparation', 'Finance', 202),
    ('LEGAL_TAX', 'Taxation Law', 'Legal', 203),
    ('TELCO_WHOLESALE', 'Technical Aspects of Wholesale', 'Telecom', 204),
    ('ENG_TECH_SPEC', 'Technical Specifications Development', 'Engineering', 205),
    ('COMM_TECH_WRITE', 'Technical Writing and Reporting', 'Communication', 206),
    ('TELCO_MARKET', 'Telecom Market & Industry Knowledge', 'Telecom', 207),
    ('TELCO_REG_POLICY', 'Telecom Regulatory Policy', 'Telecom', 208),
    ('MKT_TRADE', 'Trade Marketing', 'Marketing', 209),
    ('HR_TRAINING', 'Training Management & Facilitation', 'HR', 210),
    ('FIN_ACC_CLOSING', 'Transactional Accounting & Closing', 'Finance', 211),
    ('COMM_TRANSLATION', 'Translation & Interpretation', 'Communication', 212),
    ('NET_TRANSPORT', 'Transport Network Design & Planning', 'Network', 213),
    ('LOG_FLEET', 'Transportation & Fleet Management', 'Logistics', 214),
    ('OPS_TRAVEL', 'Travel Planning & Assistance', 'Operations', 215),
    ('FIN_TREASURY', 'Treasury Policies & Risk', 'Finance', 216),
    ('IT_TROUBLESHOOT', 'Troubleshooting & Technical Problem Solving', 'IT', 217),
    ('IT_UAT', 'User Acceptance Testing (UAT)', 'IT', 218),
    ('DIG_WEBSITE', 'Website Management', 'Digital', 219),
    ('TELCO_WHOLESALE_REG', 'Wholesale Access Regulations', 'Telecom', 220),
    ('HR_WORKFORCE', 'Workforce Management', 'HR', 221),
]
