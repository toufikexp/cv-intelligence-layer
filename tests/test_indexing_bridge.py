...
def test_build_search_document_content(fake_candidate_profile: CandidateProfile) -> None:
    doc = build_search_document(file_hash="hash123", profile=fake_candidate_profile, language="fr")
...
def test_build_search_document_minimal() -> None:
    ...
    doc = build_search_document(file_hash="min_hash", profile=profile, language=None)
...
def test_build_search_document_education_level() -> None:
    ...
    doc = build_search_document(file_hash="edu_hash", profile=profile, language="en")
